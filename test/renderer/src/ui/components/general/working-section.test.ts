...
import workingSection from "../../../../../../src/renderer/src/ui/components/general/working-section/working-section";
...
describe("Working section", () => {
    it.each(
        SECTIONS,
    )("should show %s section when selected on location", (location, selector) => {
