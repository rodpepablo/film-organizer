...
import { CollectionValidators } from "../../../domain/validators/collection";
...
import { CreateCollectionValues, SortFilmListParams } from "./types";
...
export class CollectionStoreManager {
    ...
    manageSortFilmList = (params: SortFilmListParams) => {
        ...
        this.state.collection!.films = params.newOrder.map(
            (id) => indexedFilms[id],
        );
        this.emit("render");
    };
